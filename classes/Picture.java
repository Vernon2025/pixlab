...
public class Picture extends SimplePicture {
    ...
    /** Method to grayscale all pixels in a picture **/
    ...
    /** Method to make the fish underwater easier to see **/
    public void fixUnderwater() {
        Pixel[][] pixels = this.getPixels2D();

        for (Pixel[] rowArray : pixels) {
            for (Pixel pixelObj : rowArray) {
                pixelObj.setRed((int) (pixelObj.getRed() * 1));
                pixelObj.setGreen((int) (pixelObj.getGreen() * 1));
                pixelObj.setBlue((int) (pixelObj.getBlue() * 1.2));
            }
        }
    }

    /** Method to mirror vertically **/
    public void mirrorVerticalRightToLeft()
    {
        ...
        {
            for (int col = 0; col < width / 2; col++)a
            {
    ...
    /**
     * Method to get the count of pixels with green value over a specified threshold
     * 
     * @param value the threshold value for green
     * @return the count of pixels with green value over the specified threshold
     */
    ...
    public void edgeDetection(int edgeDist) {
        ...
        for (int row = 0; row < pixels.length - 1; row++) {// horizontal edge
            for (int col = 0; col < pixels[0].length; col++) {
                topPixel = pixels[row][col];
